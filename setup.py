...
def configuration(parent_package='', top_path=None):
    ...
    config.add_extension('cflibfor',
                         ...
                         #-ftree-vectorizer-verbose=6  -fopt-info-all  -ffast-math -march=corei7-avx
                         extra_compile_args = ['-fopenmp'],
                         extra_f90_compile_args = ['-march=native','-ftree-vectorize','-g'],
